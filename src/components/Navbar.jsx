...
>
  LOG IN
          ...
          <button
            type="button"
            className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-slate-900 text-slate-200 transition hover:border-slate-500 md:hidden"
      ...
      {mobileOpen && (
        <div className="border-t border-slate-800 bg-slate-950 px-4 pb-6 pt-4 md:hidden">
          ...
          <div className="mt-4 flex flex-col gap-3">
            <button className="w-full rounded-full bg-orange-500 px-4 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-orange-400">
              Build Now
            </button>
            <div className="flex items-center gap-3">
              <button className="flex h-11 w-11 items-center justify-center rounded-full border border-slate-700 bg-slate-900 text-slate-200 transition hover:border-slate-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5">
                  <path d="M3 3h2l.4 2M7 13h10l4-8H5.4" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M7 13L5 21h14l-2-8" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M9 18a1 1 0 100 2 1 1 0 000-2zm8 0a1 1 0 100 2 1 1 0 000-2z" fill="currentColor" />
              ...
              <button className="h-11 w-11 overflow-hidden rounded-full border border-slate-700 bg-slate-900">
                <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=facearea&facepad=2&w=128&h=128&q=80" alt="Profile" className="h-full w-full object-cover" />
              </button>
            </div>
          </div>
