    ...
    >
      <div className="max-w-[1280px] mx-auto px-8 py-10 flex items-center justify-between gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            className="inline-flex items-center gap-2 font-sans font-700 text-[15px] px-6 py-3 rounded-full bg-orange-500 text-white transition hover:bg-orange-400 active:scale-[0.98]"
          >
            {slide.cta}
        ...
        {BANNER_SLIDES.map((_, i) => (
          <button
            ...
            className={`h-2.5 rounded-full transition-all duration-200 ${
              i === current ? 'bg-orange-500 w-8' : 'bg-white/50 w-2.5'
            }`}
